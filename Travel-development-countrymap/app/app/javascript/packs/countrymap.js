...
var worldDataProvider = {
  ...
  var map = AmCharts.makeChart( "chartdiv", {
    ...
    "areasSettings": {
      "autoZoom": true,
      "rollOverOutlineColor": "#ADD8E6",
      "selectedColor": "#ADD8E6",
      "color": "#ADD8E6",
      "rollOverColor": "#ADD8E6"
    },
  ...
  function handleMapObjectClick( event ) {
    if ( event.mapObject.id == "backButton" ) {
      ...
      let cities = ["Toronto", "Vancouver", "Montreal","New York","Amsterdam","Bangkok","Berlin","Chicago","DC","Hong Kong","Istanbul","Kuala Lumpur","Las Vegas","London","Los Angeles","Milan","Osaka","Paris","Prague","Rome","Seoul","Shanghai","Singapore","Sydney","Taipei","Tokyo","Vienna","Zurich"];
      var arraycontaincity = (cities.indexOf(event.mapObject.title) > -1);
      if (arraycontaincity) {
        handleCityClick(event, event.mapObject.title);
      }
    }
  }
